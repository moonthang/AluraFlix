...
const CardBanner = () => {
   ...
   return (
      ...
      <ContainerBanner id="banner">
         <ImagenFondo imagen={videoSeleccionado.imagen} >
            <Player videoId={videoSeleccionado.id} /> {/* Renderiza o Player */}
            <div>
               <header>
                  <h2>{videoSeleccionado.categoria} </h2>
                  <p>{videoSeleccionado.titulo}</p>
